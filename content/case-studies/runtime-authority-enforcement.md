...
status: featured
summary: A naval availability scenario showing how AI assistance must remain
  bounded before it influences planning, material control, execution, testing,
  or final release.
failure_pattern: Operational authority drift
mapping_focus: Map AI influence points across work identification, package
  development, routing, procurement, execution, testing, and final release.
key_principles:
